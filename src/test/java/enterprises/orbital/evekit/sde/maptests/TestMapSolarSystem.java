...
public class TestMapSolarSystem extends TestSetup {
  ...
  public void testRandomElement() {
    ...
    Assert.assertFalse(random.isBorder());
    Assert.assertTrue(random.isFringe());
    Assert.assertFalse(random.isCorridor());
    Assert.assertFalse(random.isHub());
    Assert.assertFalse(random.isInternational());
    Assert.assertFalse(random.isRegional());
    Assert.assertNull(random.isConstellation());
