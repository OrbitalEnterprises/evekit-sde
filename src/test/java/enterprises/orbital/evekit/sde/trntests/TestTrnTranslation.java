...
public class TestTrnTranslation extends TestSetup {
  ...
  public void testTableCount() {
    ...
    Assert.assertEquals(347505, contid);
  }
  ...
  public void testRandomElement() {
    ...
    Assert.assertEquals(9, random.getId().getTcID());
    Assert.assertEquals(1, random.getId().getKeyID());
    Assert.assertEquals("FR", random.getId().getLanguageID());
